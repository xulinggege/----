...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    [[ListitemLoadAndSaveModel shared] toBackGroundSave];
}
...
- (void)InitAppCheckList
{
    ...
    NSString *defaultStorePath = [[NSBundle mainBundle] pathForResource:@"travelCheck" ofType:@"plist"];
